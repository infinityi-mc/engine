...
import { PUBLIC_ENGINE_URL, PUBLIC_JWT_TOKEN } from '$env/static/public';

const ENV_ENGINE_URL = PUBLIC_ENGINE_URL as string | undefined;
const ENV_JWT_TOKEN = PUBLIC_JWT_TOKEN as string | undefined;
...
export function getToken(): string | null {
	if (typeof window === 'undefined') return ENV_JWT_TOKEN ?? null;
	return localStorage.getItem(TOKEN_KEY) ?? ENV_JWT_TOKEN ?? null;
}
